"""Basic example demonstrating how to create and configure a Swarmer agent."""
...
print(
    agent.run_loop(
        "create an instruction called math_teacher who explains math problems step by step"
    )
)
